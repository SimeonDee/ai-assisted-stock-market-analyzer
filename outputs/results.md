...
![alt text](images/stock_data.png)

## Statistical Summary

![alt text](images/stat_summary.png)

## Closing Price Trend for stock product (within period of interest)

![alt text](images/closing_price_trend.png)

## Closing Price Trend with Low and Peaks

![alt text](images/closing_price_trend_with_peak_and_low.png)

## 20-day Rolling Volatility

![alt text](images/Rolling_volatility-20-day.png)

## High Volume Volatility Days

![alt text](images/high_volume_volatility_days.png)
